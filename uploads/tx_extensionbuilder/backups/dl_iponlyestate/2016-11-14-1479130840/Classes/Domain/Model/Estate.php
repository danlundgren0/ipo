...
class Estate extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * @return void
     */
    public function addNodeType(\DanLundgren\DlIponlyestate\Domain\Model\NodeType $nodeType)
    {
     ...
     * Removes a Node
     *
     * @param \DanLundgren\DlIponlyestate\Domain\Model\NodeType $nodeTypeToRemove The NodeType to be removed
     * @return void
     */
    public function removeNodeType(\DanLundgren\DlIponlyestate\Domain\Model\NodeType $nodeTypeToRemove)
    {
     ...
     *
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\DanLundgren\DlIponlyestate\Domain\Model\NodeType> nodeType
     */
     ...
     * Sets the nodeType
     *
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\DanLundgren\DlIponlyestate\Domain\Model\NodeType> $nodeType
     * @return void
     */
