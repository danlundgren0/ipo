...
class ControlPointTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	 ...
	 * @test
	 */
	public function getReportReturnsInitialValueForReport()
	{
	 ...
	 * @test
	 */
	public function setReportForObjectStorageContainingReportSetsReport()
	{
	 ...
	 * @test
	 */
	public function getTechniciansReturnsInitialValueForTechnician()
	{
		$this->assertEquals(
			NULL,
			$this->subject->getTechnicians()
		);
	}
	 ...
	 * @test
	 */
	public function setTechniciansForTechnicianSetsTechnicians()
	{
		$techniciansFixture = new \DanLundgren\DlIponlyestate\Domain\Model\Technician();
		$this->subject->setTechnicians($techniciansFixture);
	 ...
	 * @test
	 */
	public function getResponsibleTechniciansReturnsInitialValueForTechnician()
	{
		$this->assertEquals(
			NULL,
			$this->subject->getResponsibleTechnicians()
		);
	}
	 ...
	 * @test
	 */
	public function setResponsibleTechniciansForTechnicianSetsResponsibleTechnicians()
	{
		$responsibleTechniciansFixture = new \DanLundgren\DlIponlyestate\Domain\Model\Technician();
		$this->subject->setResponsibleTechnicians($responsibleTechniciansFixture);

		$this->assertAttributeEquals(
			$responsibleTechniciansFixture,
