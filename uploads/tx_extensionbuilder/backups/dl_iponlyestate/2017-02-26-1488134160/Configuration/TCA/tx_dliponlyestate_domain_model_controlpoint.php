...
return array(
	'ctrl' => array(
		...
		'searchFields' => 'name,report,node_type,questions,allowed_technicians,alllowed_responsible_technicians,',
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, report, node_type, questions, allowed_technicians, alllowed_responsible_technicians',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, report, node_type, questions, allowed_technicians, alllowed_responsible_technicians, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'report' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:dl_iponlyestate/Resources/Private/Language/locallang_db.xlf:tx_dliponlyestate_domain_model_controlpoint.report',
			'config' => array(
				'type' => 'inline',
				'foreign_table' => '',
				'foreign_field' => 'controlpoint',
				'maxitems' => 9999,
				'appearance' => array(
					'collapseAll' => 0,
		...
		'allowed_technicians' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:dl_iponlyestate/Resources/Private/Language/locallang_db.xlf:tx_dliponlyestate_domain_model_controlpoint.allowed_technicians',
			'config' => array(
				'type' => 'select',
				'renderType' => 'selectMultipleSideBySide',
				'foreign_table' => 'fe_users',
				'MM' => 'tx_dliponlyestate_controlpoint_technician_mm',
				'size' => 10,
				'autoSizeMax' => 30,
				'maxitems' => 9999,
				'multiple' => 0,
		...
		'alllowed_responsible_technicians' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:dl_iponlyestate/Resources/Private/Language/locallang_db.xlf:tx_dliponlyestate_domain_model_controlpoint.alllowed_responsible_technicians',
			'config' => array(
				'type' => 'select',
				'renderType' => 'selectSingle',
				'foreign_table' => 'fe_users',
