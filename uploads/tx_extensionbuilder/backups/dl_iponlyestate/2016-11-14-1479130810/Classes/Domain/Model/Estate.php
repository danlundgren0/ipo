...
class Estate extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * nodeType
     *
     * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\DanLundgren\DlIponlyestate\Domain\Model\Node>
     * @cascade remove
     */
     ...
     * @return void
     */
    public function addNodeType(\DanLundgren\DlIponlyestate\Domain\Model\Node $nodeType)
    {
        $this->nodeType->attach($nodeType);
    }
    
    /**
     * Removes a Node
     *
     * @param \DanLundgren\DlIponlyestate\Domain\Model\Node $nodeTypeToRemove The Node to be removed
     * @return void
     */
    public function removeNodeType(\DanLundgren\DlIponlyestate\Domain\Model\Node $nodeTypeToRemove)
    {
        $this->nodeType->detach($nodeTypeToRemove);
    }
    
    /**
     * Returns the nodeType
     *
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\DanLundgren\DlIponlyestate\Domain\Model\Node> $nodeType
     */
     ...
     * Sets the nodeType
     *
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\DanLundgren\DlIponlyestate\Domain\Model\Node> $nodeType
     * @return void
     */
    public function setNodeType(\TYPO3\CMS\Extbase\Persistence\ObjectStorage $nodeType)
    {
