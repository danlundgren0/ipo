...
class ReportTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	 ...
	 * @test
	 */
	public function getExecutiveTechnicianReturnsInitialValueFor()
	{
		$newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
		$this->assertEquals(
			$newObjectStorage,
	 ...
	 * @test
	 */
	public function setExecutiveTechnicianForObjectStorageContainingSetsExecutiveTechnician()
	{
		$executiveTechnician = new ();
